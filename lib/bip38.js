...
Bip38.prototype.decrypt = function(encryptedKey, passphrase, address) {
  var N = this.scryptParams.N, r = this.scryptParams.r, p = this.scryptParams.p;
  ...
  // second byte for EC-multiplied key 
    ...
    throw new Error("detailalertnotvalidprivatekey");
  }

  if (!isECMult) {
    var addresshash = hex.slice(3, 7);
    var scryptBuf = scrypt(passphrase, new Buffer(addresshash), N, r, p, 64);
    var derivedHalf1 = scryptBuf.slice(0, 32);
    var derivedHalf2 = scryptBuf.slice(32, 64);
