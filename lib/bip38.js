...
Bip38.prototype.encrypt = function(wif, passphrase, address) {
  ...
  var wifBuf = cs.decode(wif, this.addressVersion.private).payload
...
Bip38.prototype.decrypt = function(encryptedKey, passphrase) {
  ...
  var shit = cs.decode(encryptedKey)
  console.log(shit.payload.toString('hex'))
  console.log(shit.version.toString('hex'))
  console.log('\n\n')
